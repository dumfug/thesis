...
\begin{figure}[h]
   ...
   \begin{subfigure}[t]{0.31\textwidth}
     ...
     \begin{tikzpicture}[node/.style={circle,fill=red!70,minimum size=1em,inner sep=3pt]}, neighbor/.style={circle,fill=blue!70,minimum size=1em,inner sep=3pt]}]
       ...
       \draw (3) -- (2);
     \end{tikzpicture}
     \caption{Here, half of the possible edges between the neighbors are present.
...
The usage of static networks in models for dynamic processes, which represent some time-depended sequences of contacts between pairs of nodes, often results in a loss of information.
