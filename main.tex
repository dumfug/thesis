...
%% general metadata:
\newcommand{\myauthor}{Matthias Wölbitsch, BSc}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{Using Neural Network Methods to Predict Activity in Online Communities}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubject}{Master's Thesis}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{TODO}  %% also used for PDF metadata (hyperref) %TODO: add keywords
...
\newcommand{\myevaluator}{TODO} %% your evaluator %TODO: do I have an evaluator?
...
\newcommand{\mysubmissionmonth}{TODO} %% month you are handing in %TODO: it's done when it's done
